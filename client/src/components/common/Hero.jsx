...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="mx-auto flex min-h-svh w-[min(1200px,calc(100%-2rem))] items-start pt-[clamp(9.5rem,20svh,13rem)] pb-32 md:w-[min(1200px,calc(100%-4rem))] md:items-center md:pt-[calc(var(--header-height)+2.5rem)] md:pb-20">
        <div className="hero-enter w-full max-w-[650px] md:ml-[12vw] md:w-[70vw] lg:ml-[20vw] lg:w-[62vw] xl:ml-[25vw] xl:w-[55vw]">
          <p className="mb-4 inline-flex w-fit items-center gap-2.5 rounded-full border border-white/15 bg-[#03142f]/30 px-3.5 py-2 text-[0.7rem] font-extrabold uppercase tracking-[0.055em] text-white/90 backdrop-blur-md md:text-[0.78rem]">
            <span className="size-2 rounded-full bg-bastly-blue shadow-[0_0_0_5px_rgba(35,127,209,0.15)]" />
            Your smarter way to learn
          </p>

          <h1
            id="hero-title"
            className="mb-4 font-heading text-[clamp(3rem,13vw,4.4rem)] leading-[0.98] font-bold tracking-[-0.06em] text-white text-shadow-lg md:mb-5 md:text-[clamp(3.2rem,6.6vw,5.2rem)] md:leading-[1.08] xl:text-[clamp(3.5rem,6vw,6.4rem)]"
          >
            <span className="block">Study smarter.</span>
            <span className="block text-[#71bfff]">Aim higher.</span>
          </h1>

          <p className="mb-6 max-w-[610px] text-base leading-[1.65] text-white/85 md:mb-7 md:text-[clamp(1rem,1.45vw,1.18rem)] md:leading-[1.78]">
            Learn with expert instructors, tackle quizzes and homework, track your
            progress, and unlock Bastly rewards — all in one place.
          </p>

          <div className="grid gap-3 min-[521px]:flex min-[521px]:flex-wrap">
            <Link
              to="/courses"
          ...
          <p className="mt-4 mb-0 text-sm text-white/65">

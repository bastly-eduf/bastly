...
studentPerformanceRouter.use(
  authenticate,
  authorize('student'),
);
studentPerformanceRouter.get(
  '/performance',
  asyncHandler(studentPerformance),
);
...
parentRouter.get(
  '/children/:studentId/performance',
  asyncHandler(parentChildPerformance),
);
parentRouter.get(
  '/children/:studentId/summary',
  asyncHandler(parentChildSummary),
);
parentRouter.get(
